...
public class BlogServiceImpl extends ServiceImpl<BlogMapper, Blog> implements IBlogService {
    ...
    public Result queryBlogLikes(Long id) {
        ...
        List<UserDTO> userDTOs = userService.query().in("id", ids).last("order by field(id," + idStr + ")").list().stream().map(user ->
    ...
    public Result saveBlog(Blog blog) {
        ...
        blog.setUserId(user.getId());//存探店博文
        ...
        //查询当前用户的所有粉丝 select * from tb_follow where follow_user_id = ?
